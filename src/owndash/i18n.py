...
EN: dict[str, str] = {
    ...
    "Mehrere Dashboard-Seiten in einem Profil": "Multiple dashboard pages in one profile",
    ...
    "Das Dashboard wird auf dem ausgewählten Monitor als randloses Vollbild angezeigt. Mit Esc oder F11 kannst du die Anzeige jederzeit beenden.":
        "The dashboard will be shown as a borderless fullscreen view on the selected monitor. Press Esc or F11 at any time to stop the display.",
